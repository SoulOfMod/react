...
const Signup = () => {
    ...
    const signup = async () => {
        try {
            const response = await axios.post("http://localhost:8000/auth/signup", { email, password, firstName, surname, dateOfBirth })
            ...
            <div className="row">
                <div className="offset-3 col-6 mx-auto">
                    ...
                    <div className="mb-3 row">
                        ...
                        <button type="submit" className="btn btn-primary mb-3" onClick={signup}>Sign Up</button>
                    </div>
                </div>
            </div>
        );
